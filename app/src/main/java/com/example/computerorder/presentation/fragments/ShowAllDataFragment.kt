    ...
    private fun initFields() {
        dataSharedViewModel.accessory.observe(viewLifecycleOwner) {
            dataSharedViewModel.apply {
                ...
                graphicCardTV.text = graphicCard.value?.graphicCardTitle.toString()
                monitorTV.text = monitor.value?.monitorTitle.toString()
    ...
    private fun createOrderObject(): Order {
        dataSharedViewModel.apply {
            return Order(
                ...
                graphicCard = graphicCard.value?.graphicCardTitle.toString(),
                monitor = monitor.value?.monitorTitle.toString(),
